...
use Akeneo\Pim\Structure\Bundle\EventSubscriber\DispatchAttributeWereCreatedOrUpdatedSubscriber;
 ...
 */
final class DispatchAttributeWereCreatedOrUpdatedSubscriberSpec extends ObjectBehavior
{
    function let(MessageBusInterface $messageBus, Clock $clock)
    {
        $this->beConstructedWith($messageBus, $clock);
    ...
    function it_is_an_event_subscriber()
    {
        ...
        $this->shouldHaveType(DispatchAttributeWereCreatedOrUpdatedSubscriber::class);
    }

    function it_dispatches_information_that_a_product_is_created(MessageBusInterface $messageBus, Clock $clock): void {
    ...
    function it_dispatches_information_that_a_product_is_updated(MessageBusInterface $messageBus, Clock $clock): void
    {
        $attribute = new Attribute();
        $attribute->setId(10);
    ...
    function it_dispatches_information_that_some_products_are_created(MessageBusInterface $messageBus, Clock $clock): void
    {
        $createdAttribute2 = new Attribute();
    ...
    function it_dispatches_information_that_some_products_are_updated(MessageBusInterface $messageBus, Clock $clock): void
    {
        $updatedAttribute2 = new Attribute();
        $updatedAttribute2->setId(10);
        $updatedAttribute2->setCode('updated_attribute2');
